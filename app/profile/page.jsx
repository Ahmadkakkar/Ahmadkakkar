...
const ProfilePage = () => {
  ...
  return (
    <>
      <div
        className="text-gray-900 mt-8 bg-cover font-sans leading-normal tracking-wider antialiased "
      ...
      >
        <div className="mx-auto my-32 flex h-auto max-w-4xl flex-wrap items-center lg:my-0 lg:h-screen ">
          <div
            id="profile"
            className="mx-6 w-full rounded-lg opacity-75 shadow-2xl lg:mx-0 lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none">
            <div className="p-4 text-center md:p-12 lg:text-left">
              ...
              <h1 className="pt-8 text-3xl font-bold lg:pt-0">{user.username}</h1>
              ...
              <p className="text-gray-600 flex items-center justify-center pt-2 text-xs lg:justify-start lg:text-sm">
                <svg
                  className="text-green-700 h-4 fill-current pr-4"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20">
              ...
              <div className="pt-12 pb-8">
                <button className="hover:bg-green-900 rounded-full bg-dark py-2 px-4 font-bold text-white">
                  Edit Profile
                </button>
              </div>
